...
export default function Artist() {
    ...
    }, [profileRef, artistInfo]);

    if (!artistInfo || !artistMovies || !artistSeries || !artistImages) {
        return <Loading />;
    }
            ...
            <div>
                <section className="artist-details">
                    <div className="artist-profile ms-2" ref={profileRef}>
                        <img loading="lazy" src={(imgsRoute + "w342" + artistInfo.profile_path) || "https://png.pngtree.com/png-clipart/20230917/original/pngtree-icon-of-unavailable-image-illustration-in-vector-with-flat-design-vector-png-image_12324700.png"} alt={artistInfo.name} />
                    </div>
                    <div className="artist-info">
                        <h1>{artistInfo.name}</h1>
                        <p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-justify-left me-1" viewBox="0 0 16 16">
                        ...
                        <hr />
                        <p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-rolodex me-1" viewBox="0 0 16 16">
                        ...
                        <hr />
                        <p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cake2-fill me-1" viewBox="0 0 16 16">
                ...
                <Section data={artistMovies} title="Artist Movies" kind="movies" />
                <Section data={artistSeries} title="Artist Series" kind="series" />
                        ...
                        {artistImages[0]? artistImages.map((img, index)=> {
                            return(
                                <div key={index} className="artist-img">
                                    <img src={imgsRoute + "w185" + img.file_path} alt="artist image" loading="lazy" className="rounded-3" />
                                </div>
                            )
